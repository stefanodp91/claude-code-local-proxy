...
export const TEXTUAL_TOOL_MANUAL = [
  ...
  "",
  "  <action name=\"python\" cmd=\"print(2**10)\"/>",
  "     Runs in a per-workspace venv with matplotlib, numpy, pandas and scipy.",
  "     A figure (plt.show()) comes back as an image and is saved in the workspace.",
  "",
  "  <action name=\"todo\" content=\"- [x] read the file\\n- [ ] change it\"/>",
